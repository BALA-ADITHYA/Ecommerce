...
//Database connection
mongoose.connect('mongodb+srv://balavengat07:naveenbala@cluster0.6op8c.mongodb.net/Ecommerce')
 //Api Creation
...
// Image Storage 
 ...
 //creating end point for resistering user
 ...
 app.post('/login', async(req,res)=>{
    ...
    if(user){
        ...
        if(passCompare){
            ...
            res.json({sucess:false,errors:'Incorrect Password'})
        }
    }else{
 ...
 // creating end point for adding cart data
 ...
 //creating end point to get cart items
